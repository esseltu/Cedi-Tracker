    ...
    <div className="min-h-screen pb-24 max-w-md mx-auto relative">
      ...
      {showUndo && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50">
          <div className="px-4 py-3 bg-gray-900 text-white rounded-xl shadow-lg flex items-center gap-3">
            <span className="text-sm">Transaction deleted</span>
            <button
              onClick={handleUndo}
              className="px-3 py-1 text-sm font-semibold bg-white text-gray-900 rounded-lg hover:bg-gray-100"
            >
              Undo
            </button>
          </div>
